...
const AddStudent = () => {
  ...
  return (
    <>
      ...
      <div className="flex grid-cols-1 justify-center items-center self-center place-content-center border bg-gray">
        <form
        ...
        >
          ...
          <button className="mt-2 bg-blue-500 border border-blue-500 p-3 text-white">
            Submit
          </button>
        </form>
      </div>
