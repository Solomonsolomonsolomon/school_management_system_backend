...
const initializeTransaction = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (amount > ((_a = req.user) === null || _a === void 0 ? void 0 : _a.balance) + 0.015 * ((_b = req.user) === null || _b === void 0 ? void 0 : _b.balance) + 100)
            throw new Error(`your balance is ${(_c = req.user) === null || _c === void 0 ? void 0 : _c.balance} not ${amount}`);
        let subaccount = yield database_1.School.findOne({ schoolId: (_d = req.user) === null || _d === void 0 ? void 0 : _d.schoolId });
        if (!subaccount)
...
const subAccount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let response = yield paystack_config_1.default.createSubAccount(res, Object.assign(Object.assign({}, body), { percentage_charge: 0.0 }));
        const bulkWriteOps = [];
        const filter = { schoolId: (_e = req.user) === null || _e === void 0 ? void 0 : _e.schoolId };
        const replacement = Object.assign(Object.assign({ schoolId: (_f = req.user) === null || _f === void 0 ? void 0 : _f.schoolId }, body), { subaccount_code: (_g = response === null || response === void 0 ? void 0 : response.data) === null || _g === void 0 ? void 0 : _g.subaccount_code });
        const updateOne = {
            updateOne: {
                filter,
                update: replacement,
