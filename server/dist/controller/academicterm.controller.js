...
class AcademicTermController {
    ...
    addATerm(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let newTerm = yield new database_1.AcademicTerm(Object.assign(Object.assign({ createdBy: (_b = req.user) === null || _b === void 0 ? void 0 : _b._id }, req.body), { school }));
            yield newTerm
                .save()
    ...
    setCurrentTerm(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let school = (_a = req.user) === null || _a === void 0 ? void 0 : _a.school;
            let previous = yield database_1.AcademicTerm.findOne({ isCurrent: true, school });
            if (previous) {
            ...
            let current = yield database_1.AcademicTerm.findOne({ _id, school });
    ...
    deleteTerm(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let term = yield database_1.AcademicTerm.findOneAndRemove({ _id, school });
            if (!term) {
    ...
    getCurrentTerm(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let school = (_a = req.user) === null || _a === void 0 ? void 0 : _a.school;
            console.log(school);
            yield database_1.AcademicTerm.findOne({ school, isCurrent: true }).then((currentTerm) => {
                if (!currentTerm)
